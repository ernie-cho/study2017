...
%>
	<table cellspacing=0 WIDTH=100% HEIGHT=100% border=3 align=center  style="border-left-style:inherit;border-right-style:inherit;border-top-style:inherit;border-bottom-style:inherit;"> <!--가장 큰테이블-->
		<tr align=center>
			<td rowspan=5 WIDTH=5%>메뉴</td>
			<td rowspan=5 WIDTH=2% BACKGROUND="image/bg2.png"></td><!--메뉴와 서버 사이의 빈공간-->
			<td colspan=5 HEIGHT=15% BACKGROUND="image/bg2.png">											<!--최상위-->
			...
			<td BACKGROUND="image/bgR.png" style="border-right:none;border-left:none">																<!--서버5 시작-->
					<table cellspacing=0 WIDTH=100% HEIGHT=100% border=0 align=center >
						<tr HEIGHT=12%>
							...
							<td align=right>
								<font color="RED" size =5><b>NG</b></font> <!--여기서 OK인지 Warning인지 받아야함-->
							</td>
						</tr>
						<tr>
						<td rowspan=2 align=center>	
