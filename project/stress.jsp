	...
	<table cellspacing=0 WIDTH=100% HEIGHT=100% border=1 align=center bordercolor=#485367> <!--가장 큰테이블-->
					...
					<td WIDTH=20% align=left>
							<table cellspacing=0 WIDTH=100% HEIGHT=100% border=0 align=center>
								<tr HEIGHT=40% align=left>
									<td>
									<input type="button" onclick="location.href='main_test.jsp'" value="HOME" class="button" >
									</td>
								</tr>
								
							</table>
						</td>
						<td WIDTH=60% align=center><font color="white" size =20><b>Server Stress Test</b></font></td>
		...
		<table border=0 width=100% height=50% cellspacing=0 bordercolor=red>
			<tr height=15%>
				...
				<td BACKGROUND="image/bg.png"><font color="white" size= 6>Usage</font></td>
			</tr>
			<tr>
				...
				<td width=69% BACKGROUND="image/bg.png" ><!--여기서 원 세개-->
					...
					<table border=0 width=100% height=69% cellspacing=0 >	
						<tr><td width=33% align=center>							
							...
							<!--버튼
							<br><input type="button" onclick="location.href='main_test.jsp'" value="Stress" class="button2">-->
						</td>
