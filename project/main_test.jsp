...
<html>
<head>
	<script src="../project/js/sample2.js"></script>
	...
	<%
	String s_url = "main_test.jsp"; //현페이지 
	%>
	<script>
...
%>
	<table cellspacing=0 WIDTH=100% HEIGHT=100% border=1 align=center  bordercolor=#485367 style="border-left-style:inherit;border-right-style:inherit;border-top-style:inherit;border-bottom-style:inherit;"> <!--가장 큰테이블-->
				...
				<table cellspacing=0 WIDTH=100% HEIGHT=100% border=0 align=center>
					<tr>
						...
						<td WIDTH=25% align=right style="vertical-align:top;">
							<font color="white" size=5><b>NO ERROR DETECTED</b></font><br>
		...
		<!--서버쪽 시작-->
			...
			<td BACKGROUND="image/bg.png" >					<!--서버1 시작-->
				<table cellspacing=0 WIDTH=100% HEIGHT=100% border=0>
					...
					<tr>
						<td rowspan=2 align=center>	
							<div height="2px" width="1px" >						
							<canvas id="chart-area1" height="50" width="50" style="border:0px solid #000000;" />
							<!--<script src="../project/js/sample.js"></script>-->
							</div>
						</td>
						
						<td align=left vertical-align=bottom border=0>
							<canvas id="chart-area2" height="100" width="100" style="border:0px solid #000000;"/>
							<!--<script src="../project/js/sample.js"></script>-->
						</td>
						<tr>
			...
			<td BACKGROUND="image/bg.png" style="border-left:none;border-right:none">																<!--서버2 시작-->
				<table cellspacing=0 WIDTH=100% HEIGHT=100% border=0 align=center >
					<tr HEIGHT=12%>
						...
						<td align=right>
							<font color="white" size =5><b>OK</b></font> 
						</td>
					</tr>
					<tr>
						<td rowspan=2 align=center>	
		...
		<tr align=center BACKGROUND="image/bg2.png" style="border:1px solid #03CDC8;">
			...
			<td BACKGROUND="image/bg.png" style="border-right:none;">																<!--서버4 시작-->
					<table cellspacing=0 WIDTH=100% HEIGHT=100% border=0 align=center >
						<tr HEIGHT=12%>
							<td align=left WIDTH=56%>
			...
			<td BACKGROUND="image/bg.png" style="border-right:none;border-left:none">																<!--서버5 시작-->
					<table cellspacing=0 WIDTH=100% HEIGHT=100% border=0 align=center >
						<tr HEIGHT=12%>
							<td align=left WIDTH=56%>
		...
		<script>
		var timer = setInterval('refresh_start()',3000); <!--5초-->
		</script>
</body>
