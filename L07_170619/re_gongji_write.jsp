...
<%
	...
	String sql= " insert into re_gongji(title, date, content) values('"+titleRead+"',date(now()),'"+contentRead+"') ";
...
<table cellspacing=0 WIDTH=600 border=0 align=center>
	<tr>
	<td colspan=3 align=center><input type="button" value="처음으로" onClick="location.href='re_gongji_list.jsp'"></td>
	</tr>
	</table>
</body>
</html>
