...
<%
	...
	String sql= " insert into gongji2(title, date, content) values('"+titleRead+"',date(now()),'"+contentRead+"') ";
...
%>
<hr></hr>
<h2 align=center>WRITTEN SUCCESS<h2>
<hr></hr>
<table cellspacing=0 WIDTH=600 border=0 align=center>
	<tr>
	<td colspan=3 align=center><input type="button" value="LIST" onClick="location.href='gongji_list.jsp'"></td>
	</tr>
	</table>
</body>
</html>
