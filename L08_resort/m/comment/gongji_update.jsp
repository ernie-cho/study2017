...
<%
	...
	ResultSet rset = stmt.executeQuery(" select * from gongji where id ="+idValue+" order by id desc ");
	rset.next();
...
%>
	...
	<tr>
		...
		<td align=left><input type=text maxlength =70 name=fixID value='<%=idCnt%>' readonly></td>
		
	</tr>
	<tr>
		<td align=center>TITLE</td>					
		<td align=left><input type=text maxlength =70 name=fixTitle value='<%=title%>'></td>
	...
	<tr>
		...
		<td align=left><textarea name=fixText
